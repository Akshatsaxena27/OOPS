...
public:
    void add_book(string title, string author, string genre) {
        if (book_count < 100) {
            ...
            book_count++;
            cout << "Book with Title:  " << title << " added to the library!!." << endl << endl;
        } else {
            cout << "Maximum Number of books added!!" << endl << endl;
        }
    }
...
int main() {
    ...
    library.add_book("ABC", "XYZ", "RP");
    library.add_book("DEF", "ASD", "JKJ");
